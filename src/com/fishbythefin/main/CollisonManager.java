...
public class CollisonManager {
    ...
    public boolean pointOnRect(HashMap<String, Integer> point, HashMap<String, Integer> rect) {
    ...
    public boolean rectOnRect(HashMap<String, Integer> rect1, HashMap<String, Integer> rect2) {
    ...
    public boolean pointOnCircle(HashMap<String, Integer> point, HashMap<String, Integer> circ) {
    ...
    public boolean circleOnCircle(HashMap<String, Integer> circ1, HashMap<String, Integer> circ2) {
